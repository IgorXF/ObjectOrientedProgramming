...
import com.mycompany.projescolamvc.gui.tablemodels.TMCadAluno;
import com.mycompany.projescolamvc.gui.tablemodels.TMCadProfessor;
...
public class JDialogProfessor extends javax.swing.JDialog {
    ...
    public JDialogProfessor(java.awt.Frame parent, boolean modal) throws SQLException {
        ...
        SQLiteConnector conexao = new SQLiteConnector("bancoP.sqlite");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (this.editando == true) {
            this.professorController.atualizarProfessor(cpfAntigo, txtNome.getText(), txtIdade.getText(), txtSexo.getText());
        } else { //Estou inserindo
            this.professorController.adicionarProfessor(txtCpf.getText(), txtNome.getText(), txtIdade.getText(), txtSexo.getText());
        }
