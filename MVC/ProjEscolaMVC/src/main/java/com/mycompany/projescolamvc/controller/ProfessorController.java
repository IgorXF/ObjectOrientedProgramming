...
public class ProfessorController {
    ...
    public void atualizarProfessor(String cpfAntigo, String nome, String idade, String sexo) {
        removerProfessor(cpfAntigo);
        adicionarProfessor(cpfAntigo, nome, idade, sexo);
    }
}
