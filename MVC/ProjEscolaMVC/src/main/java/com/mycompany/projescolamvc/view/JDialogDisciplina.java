...
public class JDialogDisciplina extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(edtHorario, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblSemestre)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(edtSemestre, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(49, 49, 49))
        );
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (this.editando == true) {
            this.disciplinaController.atualizarDisciplina(nomeAntigo, edtSemestre.getText(), edtHorario.getText());
        } else {
            this.disciplinaController.adicionarDisciplina(edtNome.getText(), edtSemestre.getText(), edtHorario.getText());
        }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        String nomeEscolhido = disciplinaEscolhida.getNome();
        
        Disciplina a = disciplinaController.buscarDisciplina(nomeEscolhido);

        if (a == null) {
            JOptionPane.showMessageDialog(this, "Não existe disciplina com este nome.");
        } else {
    ...
    private void btnEdtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEdtActionPerformed
       ...
       String nomeEscolhido = disciplinaEscolhida.getNome();
        ...
        Disciplina disciplinaEditando = disciplinaController.buscarDisciplina(nomeEscolhido);

        if (disciplinaEditando == null) {
            JOptionPane.showMessageDialog(this, "Não existe disciplina com esse nome.");
            this.editando = false;
        } else {
            this.limparCampos();
            this.habilitarCampos(true);
            ...
            this.editando = true;
            this.nomeAntigo = disciplinaEditando.getNome();
        }
    ...
    private void btnMatricularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMatricularActionPerformed
            ...
            Disciplina DisciplinaEscolhida = disciplinaController.buscarDisciplina(nomeEscolhido);
    ...
    private void btnMatricular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMatricular2ActionPerformed
            String nomeEscolhido = JOptionPane.showInputDialog("Informe o nome da disciplina que deseja adicionar o Professor Ministrante", "");
            Disciplina DisciplinaEscolhida = disciplinaController.buscarDisciplina(nomeEscolhido);
            if(DisciplinaEscolhida== null){
                 JOptionPane.showMessageDialog(this, "Disciplina não existente na escola.");
            }else {
