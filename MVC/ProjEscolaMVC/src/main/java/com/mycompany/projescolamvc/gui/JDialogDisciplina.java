 ...
 */
package com.mycompany.projescolamvc.gui;
...
import com.mycompany.projescolamvc.gui.tablemodels.TMCadDisciplina;
...
public class JDialogDisciplina extends javax.swing.JDialog {
    ...
    private DisciplinaController disciplinaController;
     ...
     public JDialogDisciplina(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
         this.editando = false;
         this.nomeAntigo = "";
        SQLiteConnector conexao = new SQLiteConnector("bancoD.sqlite");
        IDao alunoDao = new DisciplinaDAOBanco(conexao.getConnection());
        this.disciplinaController = new DisciplinaController(alunoDao);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (this.editando == true) {
            this.disciplinaController.atualizarDisciplina(nomeAntigo, txtSemestre.getText(), txtHorario.getText(), txtProfMin.getText());
        } else {
            this.disciplinaController.adicionarDisciplina(txtNome.getText(), txtSemestre.getText(), txtHorario.getText(), txtProfMin.getText());
        }
